...
public class GoldenHopperBlockEntity extends BaseHopperBlockEntity {
    public GoldenHopperBlockEntity(BlockPos pos, BlockState state) {
        super(Registry.GOLDEN_HOPPER_BLOCK_ENTITY_TYPE.get(), pos, state, 5, Config.goldenHopperTransferCooldown, "Golden Hopper");
    }
